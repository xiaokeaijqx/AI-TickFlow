...
| [tmux-codex-agent.md](./tmux-codex-agent.md)       | tmux-backed Codex CLI session contract            | Agent execution integration        |
...
| tmux-backed Codex agent  | [tmux-codex-agent.md](./tmux-codex-agent.md) |
...
| **Drive Codex through main-process tmux IPC**                  | [tmux-codex-agent.md](./tmux-codex-agent.md)   |
...
| Codex Agent IPC    | `electron/main.ts`, `electron/preload.ts`, `shared/types.ts` |
